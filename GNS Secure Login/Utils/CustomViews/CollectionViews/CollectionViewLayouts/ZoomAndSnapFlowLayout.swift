...
//  Seyanah
//
//  Created by Peter Bassem on 9/11/19.
...
class ZoomAndSnapFlowLayout: UICollectionViewFlowLayout {
    ...
    override func invalidationContext(forBoundsChange newBounds: CGRect) -> UICollectionViewLayoutInvalidationContext {
        let context = super.invalidationContext(forBoundsChange: newBounds) as? UICollectionViewFlowLayoutInvalidationContext ?? UICollectionViewFlowLayoutInvalidationContext()
